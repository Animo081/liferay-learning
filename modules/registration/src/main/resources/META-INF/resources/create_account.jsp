...
boolean preferences = ParamUtil.getBoolean(request, "preferences", false);
...
<aui:form action="<%= createAccountURL %>" method="post" name="fm">
	...
	<aui:fieldset column="<%= true %>">
		...
		<aui:col width="<%= 50 %>">
			...
			<aui:select label="Preferences" name="preferences">
				<aui:option label="Everything" value="Everything" />
				<aui:option label="Nothing" value="Nothing" />
			</aui:select>

			<aui:input label="Let others know your preferences?" name="showPreferences" type="checkbox"/>
