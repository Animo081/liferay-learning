 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link news.builder.service.impl.NewsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see news.builder.service.impl.NewsLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class NewsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements NewsLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NewsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>news.builder.service.NewsLocalServiceUtil</code>.
	 */
	...
	public News fetchNewsByUuidAndGroupId(String uuid, long groupId) {
		return newsPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<News>() {
				...
				@Override
				public void performAction(News news) throws PortalException {
	...
	public List<News> getNewsesByUuidAndCompanyId(String uuid, long companyId) {
		return newsPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<News> getNewsesByUuidAndCompanyId(
		...
		return newsPersistence.findByUuid_C(
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"news.builder.model.News", newsLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"news.builder.model.News");
	}
