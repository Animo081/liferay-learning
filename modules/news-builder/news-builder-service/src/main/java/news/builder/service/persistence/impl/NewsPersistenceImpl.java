...
package news.builder.service.persistence.impl;
...
import news.builder.model.impl.NewsImpl;
import news.builder.model.impl.NewsModelImpl;
import news.builder.service.persistence.NewsPersistence;
...
public class NewsPersistenceImpl
	...
	public News fetchByUUID_G(
		...
		if (result instanceof News) {
			...
			if (!Objects.equals(uuid, news.getUuid()) ||
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(news.uuid IS NULL OR news.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<News> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	...
	public News findByUuid_C_First(
		...
		News news = fetchByUuid_C_First(uuid, companyId, orderByComparator);
	...
	public News findByUuid_C_Last(
		...
		News news = fetchByUuid_C_Last(uuid, companyId, orderByComparator);
	...
	public News[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, news, uuid, companyId, orderByComparator, true);

			array[1] = news;

			array[2] = getByUuid_C_PrevAndNext(
				session, news, uuid, companyId, orderByComparator, false);
	...
	protected News getByUuid_C_PrevAndNext(
		Session session, News news, String uuid, long companyId,
		OrderByComparator<News> orderByComparator, boolean previous) {
	...
	public void cacheResult(News news) {
		...
		finderCache.putResult(
			...
			new Object[] {news.getUuid(), news.getGroupId()}, news);
	...
	public void clearCache(News news) {
		...
		clearUniqueFindersCache((NewsModelImpl)news, true);
	}
	...
	protected void cacheUniqueFindersCache(NewsModelImpl newsModelImpl) {
		Object[] args = new Object[] {
			newsModelImpl.getUuid(), newsModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathCountByUUID_G, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, newsModelImpl, false);
	}

	protected void clearUniqueFindersCache(
		NewsModelImpl newsModelImpl, boolean clearCurrent) {
		...
		if ((newsModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				...
				newsModelImpl.getOriginalGroupId()
			};
	...
	public News create(long newsId) {
		...
		news.setCompanyId(companyProvider.getCompanyId());
	...
	public News updateImpl(News news) {
		...
		if (isNew && (news.getCreateDate() == null)) {
			if (serviceContext == null) {
				news.setCreateDate(now);
			}
			else {
				news.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!newsModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
		...
		if (!NewsModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
			Object[] args = new Object[] {newsModelImpl.getUuid()};
			...
			args = new Object[] {
				newsModelImpl.getUuid(), newsModelImpl.getCompanyId()
			};
			...
			if ((newsModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					newsModelImpl.getOriginalUuid(),
					newsModelImpl.getOriginalCompanyId()
				};
		...
		clearUniqueFindersCache(newsModelImpl, false);
		cacheUniqueFindersCache(newsModelImpl);
	...
	public Map<Serializable, News> fetchByPrimaryKeys(
		...
		query.append(_SQL_SELECT_NEWS_WHERE_PKS_IN);
		...
		try {
			...
			for (News news : (List<News>)q.list()) {
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			NewsModelImpl.DISPLAYDATE_COLUMN_BITMASK |
			NewsModelImpl.CREATEDATE_COLUMN_BITMASK);
	...
	private static final String _SQL_SELECT_NEWS_WHERE_PKS_IN =
		"SELECT news FROM News news WHERE newsId IN (";
