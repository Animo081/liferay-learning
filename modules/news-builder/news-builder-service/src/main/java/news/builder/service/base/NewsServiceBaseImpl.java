...
package news.builder.service.base;
...
import news.builder.service.NewsService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link news.builder.service.impl.NewsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see news.builder.service.impl.NewsServiceImpl
 * @generated
 */
public abstract class NewsServiceBaseImpl
	extends BaseServiceImpl implements NewsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NewsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>news.builder.service.NewsServiceUtil</code>.
	 */
	 ...
	 */
	public news.builder.service.NewsLocalService getNewsLocalService() {
	...
	public void setNewsLocalService(
		news.builder.service.NewsLocalService newsLocalService) {
	...
	@BeanReference(type = news.builder.service.NewsLocalService.class)
	protected news.builder.service.NewsLocalService newsLocalService;
